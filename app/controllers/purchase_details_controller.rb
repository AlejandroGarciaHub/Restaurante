class PurchaseDetailsController < ApplicationController
  ...
  private
    ...
    def purchase_detail_params
      params.require(:purchase_detail).permit(:cantidad, :tomate, :lechuga, :cebolla, :mostaza, :ketchup, :mayonesa, :pepinillos, :zanahoria, :col, :pepino, :aguacate, :limon, :pechuga, :queso, :aderezo)
    end
end
